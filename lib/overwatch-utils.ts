...
export const initialHeroesData: StoredHero[] = [
  { id: 'ana',
    ...
    personalGoalLevel: 500,
    challenges: [
    { id: 's76_dmg_dealt', title: 'Damage Dealt', iconName: 'Zap', level: 1, xpPerLevel: XP_PER_HERO_TYPE_BADGE_LEVEL },
    { id: 's76_critical_hits', title: 'Critical Hits', iconName: 'Crosshair', level: 1, xpPerLevel: XP_PER_HERO_TYPE_BADGE_LEVEL },
    { id: 's76_helix_direct_hits', title: 'Helix Rocket Direct Hits', iconName: 'Target', level: 1, xpPerLevel: XP_PER_HERO_TYPE_BADGE_LEVEL },
    { id: 's76_helix_final_blows', title: 'Helix Rocket Final Blows', iconName: 'Skull', level: 1, xpPerLevel: XP_PER_HERO_TYPE_BADGE_LEVEL },
    { id: 's76_biotic_heal', title: 'Biotic Field Healing', iconName: 'HeartPulse ', level: 1, xpPerLevel: XP_PER_HERO_TYPE_BADGE_LEVEL },
    { id: 's76_tactical_kills', title: 'Tactical Visor Kills', iconName: 'Skull', level: 1, xpPerLevel: XP_PER_HERO_TYPE_BADGE_LEVEL },
